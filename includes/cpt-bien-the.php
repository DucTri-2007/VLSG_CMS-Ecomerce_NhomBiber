...
function biker_t5_render_bien_the_metabox($post) {
    ...
    <div class="biker-meta-grid">
        ...
        <div class="biker-field-group">
            ...
            <input type="number" step="1000" id="gia_ban_thuc_te" name="gia_ban_thuc_te" value="<?php echo esc_attr($gia_ban_thuc_te); ?>" placeholder="VD: 1450000" style="width:100%;">
        </div>

        <div class="biker-field-group">
            <label for="so_luong_ton_kho"><strong>Số Lượng Tồn Kho:</strong></label>
            <input type="number" min="0" id="so_luong_ton_kho" name="so_luong_ton_kho" value="<?php echo esc_attr($so_luong_ton_kho !== '' ? $so_luong_ton_kho : '10'); ?>" style="width:100%;">
        </div>
    </div>
    <?php
}
