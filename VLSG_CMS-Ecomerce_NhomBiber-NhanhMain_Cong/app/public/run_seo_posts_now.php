...
function create_or_update_seo_post($title, $slug, $content, $date, $kw, $desc) {
    ...
    if ($existing) {
        ...
        echo "SUCCESS: Updated scheduled post ID $post_id ('$title')\n";
    } else {
        $post_id = wp_insert_post($post_data);
        echo "SUCCESS: Inserted new scheduled post ID $post_id ('$title')\n";
    }
...
create_or_update_seo_post($post1_title, $post1_slug, $post1_content, $post1_date, $post1_kw, $post1_desc);
create_or_update_seo_post($post2_title, $post2_slug, $post2_content, $post2_date, $post2_kw, $post2_desc);
?>
