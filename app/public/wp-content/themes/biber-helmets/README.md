...
| :---: | :---: | :---: | :---: | :---: |
| **AGV K1 S Solid Black** | Fullface | ECE 22.06 | **3.950.000 ₫** | ![AGV](./assets/images/agv-k1-s.jpg) |
| **Shoei X-Fifteen White** | Fullface Racing | SNELL / JIS / ECE | **18.500.000 ₫** | ![Shoei](./assets/images/shoei-x15.jpg) |
| **KYT Venom Thor Marvel** | Mũ 3/4 City | ECE 22.05 | **2.200.000 ₫** | ![KYT](./assets/images/kyt-venom.jpg) |
| **LS2 FF906 Advant Carbon** | Mũ Lật Hàm 180° | Carbon ECE 22.06 | **12.500.000 ₫** | ![LS2](./assets/images/ls2-carbon.jpg) |
...
- **Triết lý *"Less is More"*:** Không dùng 5-7 plugin nặng (CPT UI, ACF, Meta Box UI). Tự viết micro-plugin `biker-helmet-manager` chuẩn PHP Native OOP.
- **4 Custom Post Types:**
...
3. Vào menu **All-in-One WP Migration > Import**, chọn tệp `Backup_BikerHelmet.wpress`.
